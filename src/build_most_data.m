...
opt = struct('pv_penetration', 1.5, 'pv_quantile', 0.5, 'hourly', true, ...
             ...
             'tou', false, 'tou_shape', [], ...
             'storage_bus', 18, 'storage_power', 1.0, 'storage_energy', 3.0, ...
...
mpc = case33mg_der('pv_penetration', opt.pv_penetration, ...
                   ...
                   'storage_power', opt.storage_power, ...
                   'storage_energy', opt.storage_energy, ...
...
ecap = opt.storage_energy;              % 能量容量 MWh（由选项给出，勿硬编码）
eff  = 0.95;                            % 单程效率
